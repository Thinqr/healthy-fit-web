...
import ThemeModeFeature from "@/components/ThemeModeFeature";
      ...
      offers: [
        {
          ...
          name: "Monthly",
          description:
            "Full access with AI scanning, personalized plans, AI Coach, and Health Score.",
        },
        {
          "@type": "Offer",
          price: "59.99",
          ...
          name: "Annual",
          description:
            "Best value. Everything in Monthly, save 58%, includes 3-day free trial.",
        },
      ],
      aggregateRating: {
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Virtually any meal, including home-cooked dishes, restaurant plates, mixed bowls, individual snacks, drinks, and packaged foods. You can also scan barcodes or nutrition labels for precise data.",
          },
        },
        {
          "@type": "Question",
