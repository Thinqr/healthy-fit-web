      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-[72px]">
        ...
        <div className="hidden lg:flex items-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 bg-ink text-white px-3.5 py-2 rounded-lg hover:bg-ink/85 transition-colors"
          >
        ...
        >
          <span
            className={`block w-5 h-[2px] bg-ink rounded transition-all duration-200 ${open ? "rotate-45 translate-y-[5px]" : ""}`}
          />
          <span
            className={`block w-5 h-[2px] bg-ink rounded transition-all duration-200 ${open ? "opacity-0" : ""}`}
          />
          <span
            className={`block w-5 h-[2px] bg-ink rounded transition-all duration-200 ${open ? "-rotate-45 -translate-y-[5px]" : ""}`}
          />
        ...
        <div className="bg-white/95 backdrop-blur-xl border-t border-border-light px-6 py-5 space-y-1">
          ...
          <div className="flex gap-2 mt-3">
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="flex-1 inline-flex items-center justify-center gap-2 bg-ink text-white px-4 py-2.5 rounded-lg"
            >
              <svg
                width="16"
                height="16"
