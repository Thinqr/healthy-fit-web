            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] leading-none opacity-50">
                    Download on the
                  </div>
              ...
              <div className="inline-flex items-center justify-center gap-3 bg-white text-ink px-6 py-3.5 rounded-xl">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-white/5 pt-8 text-center">
            <p className="text-white/20 text-sm">
              &copy; 2026 Healthy&amp;Fit. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
